class PlanLimitsChecker {
    ...
    showLimitWarnings() {
        ...
        if (this.limits.storage && this.limits.storage.percentage >= 80) {
            this.showWarningBanner('storage', this.limits.storage.percentage);
        }
    }
    ...
    showWarningBanner(type, percentage) {
        ...
        const messages = {
            ...
            branch: `You're using ${percentage.toFixed(0)}% of your branch limit (${this.limits.branches.current}/${this.limits.branches.limit}),             storage: You're using ${percentage.toFixed(0)}% of your storage limit`
    };
